...
public class Game {
    ...
    public Game(GUI gui, String name){
        ...
        /**
         * When a game object is created call initialise()
         *  You can only create 1 game so no need for synchronise
         */
        initialise();
    }
    ...
    */
    ...
    /**
     * This should be synchronised as only 1 thread should be able to access this 1 at a time
     * @return 
     */
  ...
  public void viewerJoins(Viewer v) {
    ...
    /**
     * this is double check at the end. No threads would actually be running here only EDT
